...
- **Models Published**: [`Ojasvi-Poonia/adaptivethink-qwen2.5-1.5b-grpo`](https://huggingface.co/Ojasvi-Poonia/adaptivethink-qwen2.5-1.5b-grpo) — our RL-trained Dr.GRPO LoRA adapter on Qwen2.5-1.5B (Apache-2.0).
